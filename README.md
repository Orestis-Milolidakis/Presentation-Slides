...
**Parametrized hardness results for game theory:** If computing the nash-equilibrium is hard, then surely there must be fixed-parameter attempts to the problem. We go over Mahdi Parsa's paper.
